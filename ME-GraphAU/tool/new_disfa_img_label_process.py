...
au_idx = [1, 2, 4, 6, 5, 9, 12, 20, 15, 17, 25, 26]
...
np.savetxt(list_path_prefix + 'test_label_fold3.txt', part1_numpy_list ,fmt='%d', delimiter=' ')
...
np.savetxt(list_path_prefix + 'test_label_fold2.txt', part2_numpy_list ,fmt='%d', delimiter=' ')
...
np.savetxt(list_path_prefix + 'test_label_fold1.txt', part3_numpy_list ,fmt='%d', delimiter=' ')
