...
np.savetxt(list_path_prefix + 'BP4D_test_label_fold3.txt', BP4D_image_label_part1 ,fmt='%d', delimiter=' ')
...
for frame in BP4D_image_path_list_part2:
	...
	with open(list_path_prefix + 'BP4D_test_img_path_fold2.txt', 'a+') as f:
		f.write(frame_img_name + '\n')
np.savetxt(list_path_prefix + 'BP4D_test_label_fold2.txt', BP4D_image_label_part2, fmt='%d', delimiter=' ')
...
for frame in BP4D_image_path_list_part3:
	...
	with open(list_path_prefix + 'BP4D_test_img_path_fold1.txt', 'a+') as f:
		f.write(frame_img_name + '\n')
np.savetxt(list_path_prefix + 'BP4D_test_label_fold1.txt', BP4D_image_label_part3, fmt='%d', delimiter=' ')
...
np.savetxt(list_path_prefix + 'BP4D_train_label_fold1.txt', train_img_label_fold1_numpy, fmt='%d')
...
np.savetxt(list_path_prefix + 'BP4D_train_label_fold2.txt', train_img_label_fold2_numpy, fmt='%d')
...
np.savetxt(list_path_prefix + 'BP4D_train_label_fold3.txt', train_img_label_fold3_numpy, fmt='%d')
