...
for fold in range(1,4):
    imgs_AUoccur = np.loadtxt(list_path_prefix + 'train_label_fold'+str(fold)+'.txt')
    ...
    np.savetxt(list_path_prefix+'BP4D_DISFA_weight_fold'+str(fold)+'.txt', AU_weight, fmt='%f', delimiter='\t')
